...
<body>
    <div class="container">
        ...
        <div class="sr-box">
            <form action="index.php?act=qlsp" method="post" >
                <input type="text" name="kyw" style="width: 300px; height: 33px; border-radius: 10px;">
  ...
  border-radius: 10px;">
                ...
                <input type="submit" name="listok" value="Go" style="width: 100px; height: 33px; border-radius: 10px;">
            </form>
        </div>
