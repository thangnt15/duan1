<?php
function insert_sanpham($tensp,$giacu,$giamoi,im,$mota,$ngaytao,$ngaysua,$iddm){
    $sql = "insert into sanpham(name,giacu,giamoi,img,mota,ngaytao,ngaysua,iddm) values('$tensp','$giacu','$giamoi','im','$mota','$ngaytao','$ngaysua','$iddm')";
    pdo_execute($sql);

}
function update_sanpham($id,$iddm,$tensp,$giacu,$giamoi,im,$mota,$ngaytao,$ngaysua){
   if(im!=="")
   $sql="update sanpham set iddm='".$iddm."',name='".$tensp."',giacu='".$giacu."',giamoi='".$giamoi."',img='".im."',mota='".$mota."',ngaytao='".$ngaytao."',ngaysua='".$ngaysua."' where id=".$id;
   else 
