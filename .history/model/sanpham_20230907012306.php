<?php
function insert_sanpham($tensp,$giacu,$giamoi,img,$mota,$ngaytao,$ngaysua,$iddm){
    $sql = "insert into sanpham(name,giacu,giamoi,img,mota,ngaytao,ngaysua,iddm) values('$tensp','$giacu','$giamoi','img','$mota','$ngaytao','$ngaysua','$iddm')";
    pdo_execute($sql);

}
function update_sanpham($id,$iddm,$tensp,$giacu,$giamoi,img,$mota,$ngaytao,$ngaysua){
   if(img!=="")
   $sql="update sanpham set iddm='".$iddm."',name='".$tensp."',giacu='".$giacu."',giamoi='".$giamoi."',img='".img."',mota='".$mota."',ngaytao='".$ngaytao."',ngaysua='".$ngaysua."' where id=".$id;
   else 
