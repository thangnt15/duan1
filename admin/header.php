...
<body>
    <div id="control">
        <div class="control-left">
            <a href="index.php"
                style="text-decoration: none; font-size: 25px; color: #c7fa7c; font-weight: bold; line-height: 80px;">
                Bảng điều khiển
            </a>
            <div class="line">
            ...
            <div class="option">
                ...
                <div class="options" style="margin: 20px 0;">
                    ...
                    <a href="index.php?act=qltk">Quản lý tài khoản </a>
