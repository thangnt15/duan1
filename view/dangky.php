...
<head>
    ...
    if (isset($_POST['dangky']) && ($_POST['dangky']) > 0) {
        ...
        if ($loi['user'] == '') {
            ...
            pdo_execute($sql);
            $thongbao = "Đăng kí tài khoản thành công. Bạn hãy vui lòng kiểm tra thư";
            ...
            // $message = '<p style="color: red;"<strong>Mật khẩu:'.$pass.'<a href="http://localhost/duan1-main/view/loginUser.php">Đăng nhập</a></strong>.</p>';
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="" method="post">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="user" type="text" class="form-control form-control-user"
                                            id="exampleFirstName" placeholder="Tên tài khoản">
                                ...
                                <div class="form-group">
                                    <input name="hoten" type="text" class="form-control form-control-user"
                                        id="exampleInputEmail" placeholder="Họ và tên">
                                    <p class="errorMessage">
                                ...
                                <div class="form-group">
                                    <input name="dress" type="text" class="form-control form-control-user"
                                        id="exampleInputEmail" placeholder="Địa chỉ">
                                    <p class="errorMessage">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <input name="tell" type="text" class="form-control form-control-user"
                                            id="exampleLastName" placeholder="Số điện thoại">
                                        <p class="errorMessage">
